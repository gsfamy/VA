...
description: |
  In this exercise, I learned hoow to edit a web article by using distill for RMarkdown.
author:
  - name: Gong Shufen 
...
Next, you will use the code chunk below to install and launch [**ggpubr**](https://rpkgs.datanovia.com/ggpubr/) and [**tidyverse**](https://www.tidyverse.org/packages/) in RStudio.
...
First, let us import the data into R by using [*read_csv()*](https://readr.tidyverse.org/reference/index.html)  of [**readr**](https://readr.tidyverse.org/) package.  
